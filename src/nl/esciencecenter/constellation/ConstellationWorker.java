...
public class ConstellationWorker {
    ...
    public static void main(String [] args) { 
        ...
        System.out.println("ConstellationWorker started!");     
        ...
        try {
            ...
            System.out.println("ConstellationWorker init took " + (init-start) + " ms.");
            ...
            System.out.println("ConstellationWorker finished after " + (end-start) + " ms.");
