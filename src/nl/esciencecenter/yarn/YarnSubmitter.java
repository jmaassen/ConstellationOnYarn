...
public class YarnSubmitter {
    ...
    public void submitApplicationMaster(String mainClass, String applicationOptions) throws YarnException, IOException { 
        ...
        // Create the CLASSPATH for ApplicationMaster and include the file dependencies in the LocalResources map. 
        ...
        appContext.setApplicationName("ConstellationOnYarn"); // application name
        ...
        // Submit application
        System.out.println("Submitting ApplicationMaster to YARN with ID " + appId);
        yarnClient.submitApplication(appContext);
    }

    public void waitForApplication() throws YarnException, IOException { 

        System.out.println("Waiting until ApplicationMaster is finished...");
